...
console.log("eyeColor Groups:", eyeColor);
...
for (let character of starWarsCharacters) {
  ...
  crewMass2 += character.mass;
}
console.log("crewMass2:", crewMass2);

if (crewMass2 > 1000) {
  console.log("DANGER! OVERLOAD ALERT: escape from ship now!");
} else if (crewMass2 > 900) {
  console.log("Critical Load: Over 900");
} else if (crewMass2 > 700) {
  console.log("Warning: Load is over 700");
} else if (crewMass2 > 500) {
...
for (let character of starWarsCharacters) {
  if (character.gender === "n/a") {
    ...
    console.log("Robot Character:", character);
  }
}
...
for (let i = 0; i < femaleCharacters.length; i++) {
  for (let j = 0; j < characters.length; j++) {
    if (femaleCharacters[i].name === characters[j]) characters.splice(j, 1);
  }
}
console.log("characters dopo femaleCharacters:", characters);
...
let answer = `Random Star Wars Character Selector:
name: ${randomCharacter.name},
height : ${randomCharacter.height},
mass: ${randomCharacter.mass},
hair_color: ${randomCharacter.eye_color},
skin_color: ${randomCharacter.skin_color},
eye_color: ${randomCharacter.eye_color},
birth_year: ${randomCharacter.birth_year},
